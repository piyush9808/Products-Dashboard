    ...
    return (
        <div className="relative">
            <button
                ...
                className="px-4 py-2 bg-black text-white border rounded-lg shadow-md hover:bg-gray-800"
            >
                Price Range: {selectedRange ? `${selectedRange.label}` : 'Select'}
            </button>
            {isOpen && (
                <ul className="absolute top-full left-0 mt-2 w-full bg-white border border rounded-lg shadow-md">
